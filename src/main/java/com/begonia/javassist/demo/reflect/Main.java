package com.begonia.javassist.demo.reflect;
...
public class Main {
    public static void main(String[] args) throws Throwable {
        ...
        cl.makeReflective("com.begonia.javassist.demo.reflect.Person",
                          "com.begonia.javassist.demo.reflect.VerboseMetaobj",
                          "javassist.tools.reflect.ClassMetaobject");

        cl.run("com.begonia.javassist.demo.reflect.Person", args);
    }
}
